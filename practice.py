    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    if numbers:
        if numbers[0] < numbers[1]:
            ...
            smallest = numbers[1]
        index_two_numbers = numbers[2:]
        for i in range(len(index_two_numbers)):
            if smallest < index_two_numbers[i]:
                smallest = smallest
            else:
                smallest = index_two_numbers[i]
        return smallest
    return
...
def largest_int(numbers):
    ...
    **DO NOT USE** the built-in function `max()`!
    ...
    if numbers:
        ...
        index_two_numbers = numbers[2:]
        for i in range(len(index_two_numbers)):
            if largest > index_two_numbers[i]:
                largest = largest
            else:
                largest = index_two_numbers[i]
        return largest
    return 
...
def average(numbers):
    ...
    return add_numbers / float(len(numbers))
...
def reverse_list_in_place(items):
    ...
    **Do not use** the python function `reversed()` or the method
    ...
    for index in range(length/2):
        items[index], items[length-1-index] = items[length-1-index], items[index]
